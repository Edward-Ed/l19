...
// императивный код - не читабельны, масштабный
// декларативный - можно прочитать видно всю картину целеком

// функциональное программирование
// более популярноые - рективное функциональное программирование 

// функция - одна смысловая нагрузка

// чистая функция - это 
// никаких сторонних (side) эффектов 

// является ли функция с рандомом чистой? - нет
